## Purpose
Define the API repository as the source of truth for library resource shapes (ordered products, product lists, product list items, and the download preparation response) so SDKs and applications derive their types rather than inferring them.
